...
export default function AboutPage() {
  return (
    <div className="w-full min-h-screen bg-white">
      ...
      {/* ---------------- NEW SECTION AFTER VISION & MISSION ---------------- */}
  ...
  <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12">
    ...
    <div className="flex flex-col justify-center space-y-6 text-white p-6 lg:p-8">
      ...
      <ul className="space-y-4 text-lg">
        ...
        <li className="flex items-start">
          <span className="inline-block w-2 h-2 bg-white rounded-full mt-2 mr-4 flex-shrink-0"></span>
          <span>Custom Auto Parts Designed to Meet Specific Vehicle Requirements</span>
        </li>
      </ul>
    </div>
